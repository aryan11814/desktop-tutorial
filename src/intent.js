...
import './intent.css';
import logo1 from "./assets/norton.jpg";
import logo2 from "./assets/pcicertificate.jpg";
...
<div className="logos-section">
  ...
  <div className="language-options" style={{ fontSize: "16px", color: "#555", marginTop: "5px" }}>
